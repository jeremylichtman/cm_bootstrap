  ...
  <div class="main-container container">
    <div class="main-container-inner">
      ...
      <div class="row">
        ...
        <section class="<?php print $region__content_cols; ?>">
        ...
        <?php if (!$full_width_toggle): ?>
          <?php if (!empty($page['sidebar_second'])): ?>
            <aside class="<?php print $region__sidebar_second_cols; ?>" role="complementary">
