<?php $cb_show_recent_videos_block = module_invoke('cm_bootstrap_custom_blocks', 'block_view', 'cb_show_recent_videos'); ?>
<?php $cb_show_air_dates_block = module_invoke('cm_bootstrap_custom_blocks', 'block_view', 'cb_show_air_dates'); ?>
<?php $cb_show_chapters_block = module_invoke('cm_bootstrap_custom_blocks', 'block_view', 'cb_show_chapters'); ?>
    ...
    <?php if (empty($cb_show_chapters_block['content'])): ?>
      <li role="presentation" class="recent-videos active">
        <a href="#recent-video" aria-controls="recent-video" role="tab" data-toggle="tab">
          <?php print $cb_show_recent_videos_block['title']; ?>
        </a>
      </li>
    <?php endif; ?>
    <?php if (!empty($cb_show_chapters_block['content'])): ?>
