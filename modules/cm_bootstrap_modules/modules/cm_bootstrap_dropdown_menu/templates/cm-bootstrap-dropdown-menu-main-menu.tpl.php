  ...
  <ul class="first-level">
    ...
    <?php foreach($content as $menu): ?>
      ...
      <li class="item-<?php print $i++; ?>">
        <a id="parent-trigger-<?php print $t++;?>" data-mlid="<?php print $menu['mlid']; ?>" href="<?php print url($menu['path']);?>"><?php print $menu['title'];?></a>
        <ul class="second-level" data-mlid="<?php print $menu['mlid']; ?>">
