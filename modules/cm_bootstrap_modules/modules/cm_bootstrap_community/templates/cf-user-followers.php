...
<?php
  $following = _cm_bootstrap_community_get_following($account->uid);
  $follows = _cm_bootstrap_community_get_follows($account->uid);
  $likes = _cm_bootstrap_community_get_likes($account->uid);
  $recent_videos = _cm_bootstrap_community_get_recent_videos($account->uid);
  $video_count = _cm_bootstrap_community_get_user_video_count($account->uid);
?>
