<style>
  ...
  #block-spnn-helper-spnn-homepg-block-1 {
    opacity:0;
  }
</style>
<script>
  (function ($, Drupal) {
    $(window).load(function (){
      ...
      if ($('#block-spnn-helper-spnn-homepg-block-1').length) {
        $('#block-spnn-helper-spnn-homepg-block-1').fadeTo(750, 1,'swing');
      }
    });
  })(jQuery, Drupal);
</script>
...
<div id="main">
  ...
  <div class="main-container container-fluid above_content">
    <div class="row">
      <?php print render($page['above_content']); ?>
    </div>
  </div>

  <div class="main-container container-fluid region-content">
